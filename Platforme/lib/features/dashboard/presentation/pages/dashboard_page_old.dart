...
class _DashboardPageState extends State<DashboardPage>
  ...
  void initState() {
    ...
    // Charger les donn├⌐es initiales (entreprises, stats, etc.)
    ...
    return MainShell(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
              ...
              child: SlideTransition(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Bienvenue, voici un aper├ºu de votre gestion actuelle.',
          ...
          // ΓöÇΓöÇΓöÇ KPI Cards (animated counter) ΓöÇΓöÇΓöÇ
          ...
          const SizedBox(height: 24),
            ...
            // ΓöÇΓöÇΓöÇ Actions & Calendar ΓöÇΓöÇΓöÇ
            FadeTransition(
              opacity: _fadeAnim,
              child: SlideTransition(
      ...
      child: Column(
        ...
        children: [
          ...
          _actionItem(
            ...
            'V├⌐rification de la Paie',
            'Validation finale n├⌐cessaire pour le mois de Juin.',
          ...
          _actionItem(
            ...
            'Candidat : Marc Lefebvre - D├⌐veloppeur Senior.',
          ...
          _actionItem(
            ...
            'Planning Annuel',
            "Mise ├á jour du calendrier des cong├⌐s d'├⌐t├⌐.",
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // Events
          _calEvent(AppColors.primary, 'R├⌐union d\'├⌐quipe - 14:00'),
          const SizedBox(height: 8),
          _calEvent(AppColors.error, 'Cl├┤ture des cong├⌐s - 17:00'),
        ],
      ),
    );
  }
