...
\subsection{Design Pattern & Architectural Layers}
The codebase of both the mobile and web client applications is structured around a decoupled **Model-View-Controller (MVC)** design pattern to separate business logic from the user interface presentation:
