...
This first chapter establishes the context of our graduation project. It presents the professional environment where the internship took place, describes the host organization's operational structure, formulates the exact problem statement to be solved, and proposes the conceptual approach chosen. Finally, a literature review compares existing solutions to validate our technical decisions.
...
\begin{enumerate}
    \item \textbf{A Web Administration Platform:} Dedicated to HMI Stars Consulting managers, allowing them to register client companies, review uploaded files (categorized by type: KBIS, VAT, RIB, bank statements ...), and reply to client inquiries.
